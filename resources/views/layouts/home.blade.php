...
<html>
    ...
    <body>
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><img src="{!! asset('img/logosmk.png') !!}" class="img-responsive" alt=""></a>
        ...
        <main>
            <div class="parallax">
                <div class="caption">
                    <!-- <span class="border"> SMK NEGERI 09<span style="color:#30a5ff;">SEMARANG</span></span> -->
                    <br>
                    <a href="#tentang"></i></a>
                </div>
            </div>
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="panel panel-container">
                                ...
                                <div class="panel-body">
                                    <p>AN ABSENSI merupakan sistem absensi siswa di SMK NEGERI 9 SEMARANG yang dapat mempermudah dalam proses absensi. Absensi ini memiliki banyak kelebihan.</p>
                                </div>
                            </div>
                            <div class="panel panel-container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav nav-pills nav-justified">
                            <li><a href="/">© {{date('Y')}}. Riana Ainun</a></li>
                        </ul>
                    </div>
                </div>
            </div>
